<div class="container mt-0" style="max-width: 100% !important;">
    ...
    <div class="mt-4 field-input d-flex justify-content-center align-items-center">
        <form action="<?php echo _HOST_PATH_ ?>\admin\Tickets\postEditTypeTicket\id=<?php echo $detail['ticket_id'] ?>"
            method="post" class="w-50" enctype="multipart/form-data">
            <div class="mb-3">
                <label for="">Tên loại vé</label>
                <input type="text" name="ticket_name" id="" value="<?php echo $detail['ticket_name'] ?>"
                    class="form-control">
            </div>
            ...
            <div class="mb-3 d-flex align-items-center">
                <img width="20%"
                    src="<?php echo _HOST_PATH_ ?>\public\assets\admin\images\ticket_type_image\<?php echo $detail['ticket_icon'] ?>"
                    alt="">
