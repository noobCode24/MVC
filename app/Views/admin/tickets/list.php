        ...
        if (!empty($list)) {
            foreach ($list as $key => $value) {
                ...
                <tr>
                    ...
                    <td>
                        <img width="80px"
                            src="<?php echo _HOST_PATH_ ?>\public\assets\admin\images\ticket_type_image\<?php echo $value['ticket_icon'] ?>"
                            alt="">
                    </td>
                    ...
                    <td>
                        <a
                            href="<?php echo _HOST_PATH_ ?>/admin/Tickets/getEditTypeTicket/id=<?php echo $value['ticket_id'] ?>">
                            <i class="btn btn-warning fa-solid fa-pen-to-square"></i>
                        </a>
                    </td>
                    <td>
                        <a href="<?php echo _HOST_PATH_ ?>/admin/Tickets/handleDeleteTypeTicket/id=<?php echo $value['ticket_id'] ?>"
