...
<form action="<?php echo _HOST_PATH_ ?>/admin/Events/" method="post" class="">
    <div class="action d-flex align-items-center">
        ...
        <div class="search d-flex">
            <a href="<?php echo _HOST_PATH_ ?>/admin/Events/" class="btn btn-warning m-3 py-2"
    ...
    <div class="filter mb-3 ms-3">
        ...
        <div class="mb-3 d-flex">
            <div style="width: 20% !important;" class="me-3">
                ...
                <input style="cursor: pointer !important;" type="date" name="created_at" id="" class="form-control"
        ...
        <tr>
            ...
            if (!empty($events)) {
                ...
                <tr>
                    ...
                    <td><img width="200px"
                            src="<?php echo _HOST_PATH_ ?>\public\assets\admin\images\event_image\<?php echo $value['event_image'] ?>"
                            alt=""></td>
                    ...
                    <td>
                        <a href="<?php echo _HOST_PATH_ ?>/admin/Events/handleDeleteEvent/id=<?php echo $value['event_id'] ?>"
