<div class="container w-70 mt-0" style="max-width: 100% !important;">
   ...
   <div class="handel-field m-3">
    ...
    <div class="mt-4 field-input d-flex justify-content-center align-items-center">
        <form action="<?php echo _HOST_PATH_?>/admin/EnterCategoriesService/postAddEnterCategoryService" method="post" class="w-50">
            <div class="mb-3">
                <label for="">Tên danh mục</label>
                <input type="text" name="escate_name" id="" class="form-control" placeholder="Nhập tên danh mục...">
            </div>
            <div class="mb-3">
                <label for="">Mô tả</label>
                <textarea name="escate_desc" id="" class="form-control" placeholder="Nhập mô tả..."></textarea>
            </div>
            <div class="mb-3">
