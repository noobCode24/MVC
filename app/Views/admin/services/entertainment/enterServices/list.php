...
<table class="table table-bordered text-center">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a href="<?php echo _HOST_PATH_ ?>/admin/EnterServices/handleDeleteEnterServices/id=<?php echo $value['enterservice_id'] ?>" onclick="return confirm('Bạn có chắc chắn muốn xóa')">
...
<!-- <?php
$filePath = 'CẢNH BÁO LỪA ĐẢO KHI MUA LẠI VÉ VUI CHƠI TẠI CÔNG.docx';
readDocx($filePath);
?> -->
</div>