    ...
    <div class="detail mt-3 w-50 m-auto">
        <form action="" method="post">
            ...
            <div class="mb-3">
                ...
                <textarea style="height: fit-content;" disabled name="enterservice_desc" id="" class="form-control" style="height: 120px !important;"><?php echo $detail['enterservice_desc'] ?></textarea>
            </div>
            <div class="mb-3">
