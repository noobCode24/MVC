    ...
    <form action="<?php echo _HOST_PATH_ ?>/admin/Customer/" method="post" class="">
        <div class="action d-flex align-items-center">
            ...
            <div class="input-group w-50">
                <input type="search" name="full_name" id="" class="form-control"
                    placeholder="Nhập tên khách hàng để tìm kiếm...">
                <button class="btn btn-primary" type="submit">
                    <i style="cursor: pointer; height: 100%;"
                        class="btn btn-primary d-flex input-group-text fa-solid fa-magnifying-glass"></i>
                </button>
            </div>
            <div class="search d-flex">
                <a href="<?php echo _HOST_PATH_ ?>/admin/Customer/" class="btn btn-warning m-3 py-2"
            ...
            if (!empty($listCustomer)) {
                foreach ($listCustomer as $key => $value) {
                    ...
                    <tr>
                        ...
                        <td>
                            <a
                                href="<?php echo _HOST_PATH_ ?>/admin/Customer/getEditCustomer/id=<?php echo $value['customer_id'] ?>">
                                <i class="btn btn-warning fa-solid fa-pen-to-square"></i>
                            </a>
                        </td>
                        <td>
                            <a href="<?php echo _HOST_PATH_ ?>/admin/Customer/handleDeleteCustomer/id=<?php echo $value['customer_id'] ?>"
