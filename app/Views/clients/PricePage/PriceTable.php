...
<div class="container mt-5">
    <div class="video-label d-flex">
        ...
        <h4 class="d-flex align-items-center m-0 ms-3 fs-2"><?php echo ($titlePrice == "" ? 'Bảng giá' : $titlePrice) ?>
        </h4>
    </div>
        ...
        if (!empty($serviceList)) {
            foreach ($serviceList as $key => $value) {
                ...
                <a href="<?php echo _HOST_PATH_ ?>/clients/PriceTable?<?php echo $value['serviceCate_id'] ?>">
                    <img class="hover-trans"
                        src="<?php echo _HOST_PATH_ ?>\public\assets\admin\images\service_image\<?php echo $value['serviceCate_icon'] ?>"
                        alt="">
                </a>
                <?php
            }
        ...
        if (!empty($newService)) {
            foreach ($newService as $key => $value) {
                ...
                <div class="col-4 mb-5">
                    <a
                        href="<?php echo _HOST_PATH_ ?>\public\assets\admin\images\priceTable_image\<?php echo $value['service_img'] ?>">
                        <img height="224px" class="w-100 hover-trans img-border mb-3" style="border-radius: 0 !important;"
                            src="<?php echo _HOST_PATH_ ?>\public\assets\admin\images\priceTable_image\<?php echo $value['service_img'] ?>"
                            alt="">
                    </a>
