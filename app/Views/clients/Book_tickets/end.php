...
<body>
    ...
    <div class="wrapper">
                ...
                <div class="form-container_complete">
                    <div class="customer-info_complete">
                        <div class="text-date-complete">
                            <h1>Ngày sử dụng: <span id="ticket-date_complete">19/6/2024</span></h1>
                        </div>
                        <table class="table">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                <tr>
                                    <td>VÉ THAM QUAN KHÁCH CAO TRÊN 1,3M</td>
                                    <td>28-06-2024</td>
                                    <td>3</td>
                                    <td>390,000 VND</td>
                                    <td>1,170,000 VND</td>
        ...
        <script src="<?php echo _HOST_PATH_ ?>\public\assets\clients\js\book_tickets_js\script.js"></script>
</body>
