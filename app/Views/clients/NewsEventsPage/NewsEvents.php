...
<div class="container px-5 mb-5">
    ...
    <div class="events mt-3">
        ...
        <!-- Slide Event-->
        <div id="carouselExample" class="carousel slide m-auto w-100">
            <div class="carousel-inner ">
                <?php
                for ($i = 0; $i < count($events); $i++) {
                    ?>
                    <div class="event p-3 carousel-item <?php echo ($i == 0 ? 'active' : '') ?>" onclick="showDetail(this)">
                        <a style="width: 100%;" href="#event-detail">
                            <img class="img-border" style=" width: 100%; max-height: 361px; min-height: 361px;" width="49%"
                                src="<?php echo _HOST_PATH_ ?>\public\assets\clients\images\news_events\<?php echo $events[$i]['event_image'] ?>"
                                alt="...">
                        </a>
                    </div>
                    <div id="overlay" class="overlay justify-content-center align-items-center" style="display: none;">
                        <div id="event-detail" class="event-detail position-relative h-100">
    ...
    <div class="news mt-3">
        ...
        if (!empty($priNew[0])) {
            ...
            <div class="primary-new mb-3 d-flex mt-5">
                <a href="#" class="w-50">
                    <img src="<?php echo _HOST_PATH_ ?>\public\assets\admin\images\new_image\<?php echo $priNew['new_image'] ?>"
                        alt="" class="img-hover img-border w-100 hover-trans">
                </a>
                <div class="content ms-5 w-50">
                    <a href="#" style="color: #000; font-weight: 530;"
                        class="title hover ms-0 fs-6"><?php echo $priNew['new_title'] ?></a>
                    ...
                    for ($j = 0; $j < 3; $j++) {
                        ...
                        <div style="width: 33% !important;" class="col d-flex justify-content-between mb-4">
                            <a href="#" style="width: 32%;">
                                <img style="width: 100%; height: 120px" class="img-border hover-trans"
                                    src="<?php echo _HOST_PATH_ ?>\public\assets\admin\images\new_image\<?php echo $secNew[$k]['new_image'] ?>"
                                    alt="">
                            </a>
                            <div style="width: 65%;" class="ms-3">
                                ...
                                <div class="date-publish">
                                    ...
                                    <span style="font-size: 14px;"
                                        class="mb-3 text-secondary"><?php echo $secNew[$k]['created_at'] ?></span>
                                </div>
                            </div>
                        </div>
                        <?php
            ...
            <nav aria-label="Page navigation example">
                <ul class="pagination">
                    ...
                    for ($i = 0; $i < floor($cntSec / 9 + 1); $i++) {
                        ?>
                        <li class="page-item"><a style="color: var(--hover-color); <?php if ($page == $i + 1)
                            echo " background-color: rgba(0,0,0,0.1);" ?>" class="page-link fw-bold"
                                    href="?page/<?php echo $i + 1 ?>"><?php echo $i + 1 ?></a></li>
                        <?php
                    }
                    ?>
                    <li class="page-item">
