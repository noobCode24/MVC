...
<body>
    <div class="container-layout d-flex justify-content-between">
        ...
        <div class="content" style="width: 80% !important; right: -20% !important;">
            <div class="navbar-layout position-fixed w-100"
                style="right: 0 !important; width: 80% !important; z-index: 1000;">
                <?php
            ...
            <div class="content-layout w-100" style="position: relative; right: -25%; padding-top: 5%">
                <?php
